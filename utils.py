...
def safe_divide(a: Union[int, float], b: Union[int, float], default: Optional[Union[int, float]] = None) -> Optional[Union[int, float]]:
    """
    ...
    Args:
        a: Numerator
        b: Denominator
        default: Value to return if b is zero (defaults to None)
